...
```bash
curl -O https://raw.githubusercontent.com/proamo/reinstall/main/reinstall.sh || wget -O reinstall.sh $_
```

国内服务器：

```bash
curl -O https://jihulab.com/bin456789/proamo/-/raw/main/reinstall.sh || wget -O reinstall.sh $_
```
